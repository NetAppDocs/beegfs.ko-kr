...
NOTE: BeeGFS v8로 업그레이드하는 경우 link:clusters-upgrade-beegfs-v8.html["BeeGFS v8로 업그레이드"] 절차를 참조하십시오.
...
| 7.4.6 | 8.0 | 예 | link:clusters-upgrade-beegfs-v8.html["BeeGFS v8로 업그레이드"] 절차의 지침을 사용하여 업그레이드하십시오. 


| 7.4.6 | 8.1 | 예 | link:clusters-upgrade-beegfs-v8.html["BeeGFS v8로 업그레이드"] 절차의 지침을 사용하여 업그레이드하십시오. 


| 7.4.6 | 8.2 | 예 | link:clusters-upgrade-beegfs-v8.html["BeeGFS v8로 업그레이드"] 절차의 지침을 사용하여 업그레이드하십시오. 
|===
