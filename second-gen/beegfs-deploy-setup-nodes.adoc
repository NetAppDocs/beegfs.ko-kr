...
....
. link:beegfs-technology-requirements.html["기술 요구 사항"]에 권장된 버전으로 모든 HCA 펌웨어를 link:../administer/clusters-update-hca-firmware.html["파일 노드 어댑터 펌웨어를 업데이트합니다"^] 가이드를 사용하여 업데이트하십시오.
